...
var VXFormTree = /** @class */ (function () {
    ...
    function () {
        /** @type {?} */
        var id = get(this.fieldConfig, "templateOptions.treeid");
...
var VXFormOrg = /** @class */ (function () {
    ...
    function () {
        /** @type {?} */
        var orgControl = get(this.fieldConfig, "templateOptions.controlid");
...
var VXFormFieldLookUp = /** @class */ (function (_super) {
    ...
    function () {
        ...
        var template;
        /** @type {?} */
        var type = get(this.field, "templateOptions.type");
        /** @type {?} */
        var para = {
