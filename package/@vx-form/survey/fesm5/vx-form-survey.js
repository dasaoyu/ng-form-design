...
import { Injectable, EventEmitter, Component, Input, ViewContainerRef, ViewChild, ChangeDetectorRef, ComponentFactoryResolver, Output, forwardRef, NgZone, ElementRef, Directive, Pipe, ɵɵdefineInjectable, ɵɵinject, NgModule } from '@angular/core';
...
var VXSurveyDesignDetail = /** @class */ (function () {
    ...
    function (res) {
        ...
        switch (resType) {
            ...
            case "copy":
                /** @type {?} */
                var copyQuestion = cloneDeep(rQuestion);
...
var VXSurveyModule = /** @class */ (function () {
    ...
    VXSurveyModule.decorators = [
        { type: NgModule, args: [{
                    ...
                    exports: __spread([TranslateModule, publicComponent, ContenteditableModel, InlineEditorComponent], PIPES),
                    providers: __spread([
