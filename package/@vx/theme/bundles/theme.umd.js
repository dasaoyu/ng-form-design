/**
 * @license ng-vx(cipchk@qq.com) v1.0.0
 * (c) 2019 cipchk https://ng-vx.com/
 * License: MIT
 */
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@vx/acl'), require('@angular/common'), require('@angular/platform-browser'), require('@angular/router'), require('@vx/util'), require('ng-zorro-antd/modal'), require('ng-zorro-antd/drawer'), require('@angular/common/http'), require('date-fns/distance_in_words_to_now'), require('date-fns/format'), require('@angular/cdk/overlay'), require('@ant-design/icons-angular/icons'), require('ng-zorro-antd/icon')) :
    typeof define === 'function' && define.amd ? define('@vx/theme', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@vx/acl', '@angular/common', '@angular/platform-browser', '@angular/router', '@vx/util', 'ng-zorro-antd/modal', 'ng-zorro-antd/drawer', '@angular/common/http', 'date-fns/distance_in_words_to_now', 'date-fns/format', '@angular/cdk/overlay', '@ant-design/icons-angular/icons', 'ng-zorro-antd/icon'], factory) :
    (global = global || self, factory((global.vx = global.vx || {}, global.vx.theme = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.vx.acl, global.ng.common, global.ng.platformBrowser, global.ng.router, global.vx.util, global['ng-zorro-antd/modal'], global['ng-zorro-antd/drawer'], global.ng.common.http, global.distanceInWordsToNow, global.format, global.ng.cdk.overlay, global.icons, global['ng-zorro-antd/icon']));
    ...
    ***************************************************************************** */
    ...
    /** @type {?} */
    var VX_I18N_TOKEN = new core.InjectionToken('vxTranslatorToken', {
        providedIn: 'root',
    ...
    var VXI18NServiceFake = /** @class */ (function () {
        ...
        /** @nocollapse */ VXI18NServiceFake.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function VXI18NServiceFake_Factory() { return new VXI18NServiceFake(); }, token: VXI18NServiceFake, providedIn: "root" });
    ...
    var MenuService = /** @class */ (function () {
        ...
        MenuService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [VX_I18N_TOKEN,] }] },
            { type: acl.ACLService, decorators: [{ type: core.Optional }] }
        ]; };
        /** @nocollapse */ MenuService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function MenuService_Factory() { return new MenuService(core.ɵɵinject(VX_I18N_TOKEN, 8), core.ɵɵinject(acl.ACLService, 8)); }, token: MenuService, providedIn: "root" });
        return MenuService;
    }());
    if (false) {
        /**
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var VXThemeConfig = /** @class */ (function () {
        function VXThemeConfig() {
        }
        VXThemeConfig.decorators = [
            { type: core.Injectable, args: [{ providedIn: 'root' },] }
        ];
        /** @nocollapse */ VXThemeConfig.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function VXThemeConfig_Factory() { return new VXThemeConfig(); }, token: VXThemeConfig, providedIn: "root" });
        return VXThemeConfig;
    }());
    if (false) {
        /** @type {?} */
    ...
    var ResponsiveService = /** @class */ (function () {
        ...
        /** @nocollapse */ ResponsiveService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ResponsiveService_Factory() { return new ResponsiveService(core.ɵɵinject(VXThemeConfig)); }, token: ResponsiveService, providedIn: "root" });
     ...
     */
    /** @type {?} */
    var DELON_LOCALE = new core.InjectionToken('vx-locale');
    ...
    var DELON_LOCALE_SERVICE_PROVIDER = {
        ...
        deps: [[new core.Optional(), new core.SkipSelf(), VXLocaleService], DELON_LOCALE],
    };
     ...
     */
    var ɵ0 = zhCN;
    var VXLocaleModule = /** @class */ (function () {
        function VXLocaleModule() {
        }
    ...
    var _HttpClient = /** @class */ (function () {
        ...
        /** @nocollapse */ _HttpClient.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function _HttpClient_Factory() { return new _HttpClient(core.ɵɵinject(http.HttpClient), core.ɵɵinject(VXThemeConfig)); }, token: _HttpClient, providedIn: "root" });
        return _HttpClient;
    }());
    if (false) {
        /**
    ...
    var I18nPipe = /** @class */ (function () {
        ...
        I18nPipe.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [VX_I18N_TOKEN,] }] }
        ]; };
        return I18nPipe;
    }());
    if (false) {
    ...
    var VXThemeModule = /** @class */ (function () {
        ...
        VXThemeModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: __spread(COMPONENTS, PIPES, [VXLocaleModule]),
                    },] }
        ];
        /** @nocollapse */
    ...
    exports.VXI18NServiceFake = VXI18NServiceFake;
    exports.VXLocaleModule = VXLocaleModule;
    exports.VXLocaleService = VXLocaleService;
    exports.VXThemeConfig = VXThemeConfig;
    exports.VXThemeModule = VXThemeModule;
    exports.VX_I18N_TOKEN = VX_I18N_TOKEN;
    ...
    exports.zh_CN = zhCN;
    exports.zh_TW = zhTW;
    exports.ɵa = VX_I18N_TOKEN_FACTORY;
    exports.ɵb = I18nPipe;
